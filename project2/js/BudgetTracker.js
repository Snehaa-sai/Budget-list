    ...
    static html() {
        ...
        <br><br>
            <table class="budget-tracker">
                ...
                <tbody>
                    <tr>
                        <td colspan="7" class="controls">
                            <button type="button" class="new-entry btn btn-primary">New Entry</button>
                        </td>
                    </tr>
                </tbody>
                <tfoot>
            ...
            <div class="d-grid gap-2 col-6 mx-auto">
                 <a href="/project2/finance/index.html" class="btn btn-outline-success" role="button" >Finance Department</a>
            </div>
        `;
    }
